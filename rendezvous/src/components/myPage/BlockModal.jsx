...
const BlockModal = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30" onClick={onClose}>
      ...
      <div className="bg-white w-[90%] max-w-md rounded-lg shadow-lg overflow-hidden" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex flex-col">
          ...
          <div className="bg-gray-100 px-5 py-3 border-y border-gray-200">
            ...
            <p className="text-xs text-gray-500 mt-1">전화번호나 이메일 주소를 입력하세요</p>
          </div>
